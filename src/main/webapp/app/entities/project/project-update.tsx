      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterApp.project.home.createOrEditLabel" data-cy="ProjectCreateUpdateHeading">
            <Translate contentKey="jhipsterApp.project.home.createOrEditLabel">Create or edit a Project</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterApp.project.name')}
                id="project-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterApp.project.description')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterApp.project.lastModifiedDate')}
