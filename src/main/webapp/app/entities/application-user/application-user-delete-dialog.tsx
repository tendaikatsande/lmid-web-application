...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterApp.applicationUser.delete.question">
        <Translate contentKey="jhipsterApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
