...
export const ProvinceUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...provinceEntity,
          createdDate: convertDateTimeFromServer(provinceEntity.createdDate),
          lastModifiedDate: convertDateTimeFromServer(provinceEntity.lastModifiedDate),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterApp.province.home.createOrEditLabel" data-cy="ProvinceCreateUpdateHeading">
            <Translate contentKey="jhipsterApp.province.home.createOrEditLabel">Create or edit a Province</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterApp.province.name')}
                id="province-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterApp.province.lastModifiedDate')}
                id="province-lastModifiedDate"
