...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './funder.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_FUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUNDER actions', async () => {
      const expectedActions = [
        {
