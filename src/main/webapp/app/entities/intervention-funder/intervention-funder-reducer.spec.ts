...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './intervention-funder.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERVENTIONFUNDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERVENTIONFUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERVENTIONFUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERVENTIONFUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERVENTIONFUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERVENTIONFUNDER actions', async () => {
      const expectedActions = [
        {
