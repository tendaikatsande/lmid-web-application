...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './intervention-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERVENTIONTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERVENTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERVENTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERVENTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERVENTIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERVENTIONTYPE actions', async () => {
      const expectedActions = [
        {
