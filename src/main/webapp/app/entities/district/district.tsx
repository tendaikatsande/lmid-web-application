  ...
  return (
    <div>
      <h2 id="district-heading" data-cy="DistrictHeading">
        <Translate contentKey="jhipsterApp.district.home.title">Districts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterApp.district.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/district/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterApp.district.home.createLabel">Create new District</Translate>
          </Link>
        </div>
      </h2>
        ...
        {districtList && districtList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterApp.district.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('lng')}>
                  <Translate contentKey="jhipsterApp.district.lng">Lng</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('lng')} />
                </th>
                <th className="hand" onClick={sort('lat')}>
                  <Translate contentKey="jhipsterApp.district.lat">Lat</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('lat')} />
                </th>
                ...
                <th>
                  <Translate contentKey="jhipsterApp.district.province">Province</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {districtList.map((district, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{district.lng}</td>
                  <td>{district.lat}</td>
                  <td>{district.createdDate ? <TextFormat type="date" value={district.createdDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>
                    {district.lastModifiedDate ? (
                      <TextFormat type="date" value={district.lastModifiedDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterApp.district.home.notFound">No Districts found</Translate>
            </div>
          )
        )}
      </div>
