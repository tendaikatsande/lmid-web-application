...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERVENTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERVENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERVENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERVENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERVENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERVENTION actions', async () => {
      const expectedActions = [
        {
