...
/**
 * Criteria class for the {@link zw.co.ema.domain.Province} entity. This class is used
 * in {@link zw.co.ema.web.rest.ProvinceResource} to receive all the possible filtering options from
...
public class ProvinceCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, lng, lat, createdDate, lastModifiedDate, distinct);
    }
