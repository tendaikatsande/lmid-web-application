...
/**
 * Criteria class for the {@link zw.co.ema.domain.Project} entity. This class is used
 * in {@link zw.co.ema.web.rest.ProjectResource} to receive all the possible filtering options from
...
public class ProjectCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, startDate, endDate, createdDate, lastModifiedDate, distinct);
    }
